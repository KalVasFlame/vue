<template>
  <div class="w-70 center  d-flex jc-sb ai-c">
  <div class="login-form-wrapper mr-20">
    <h1 class="h4">Login or Registration</h1>
    <div class="login-type-btns mt-80">
    ...
    <input type="text" v-if="isCodeSent" v-model="state.code" placeholder="Enter Code" class="input mt-30">
  <label class="container-cbx ">
    <input type="checkbox" v-model="state.agree">
    <span class="checkmark"></span>
    <span class="policy-text">I agree to receive SMS/text massages. SMS data rates may apply.<br/> I agree with <a class="policy-URL">Privacy Policy</a></span>
  </label>

  <button class="btn primary" @click="submitForm">{{isCodeSent ? "Log In" : "Get SMS"}}</button>
  </div>
  <div class="login-img-container">
    <img src="@/assets/images/login-form.jpg" alt="as">
  </div>
  </div>
</template>
